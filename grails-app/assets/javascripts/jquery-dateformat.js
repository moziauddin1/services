    ...
    $.format = (function () {
        ...
        return {
            ...
            prettyDate: function (time) {
                ...
                year_diff = Math.abs(date.getFullYear() - now.getFullYear());
                month_diff = Math.abs(date.getMonth() - now.getMonth());
                ...
                if (abs_diff < 60) {
                    ...
                    return month_diff + ' months' + tense;
                } else if (month_diff > 0) {
                    return this.pluralize(' year', year_diff) + ' and ' + this.pluralize(' month', month_diff) + tense;
                } else {
                    return this.pluralize(' year', year_diff) + tense;
                }
            },
