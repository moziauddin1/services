...
TIP: Ithink the pre-publish check intelligent method is probaly the simplest and best option for all users and for
scaling to uber/compiled or just autonomous/random trees created by "others".