...
Checks if the name of the taxon is a synonym of name already placed on the tree. You need to replace
or modify the accepted taxon.

=== check Synonyms Of Name Not On The Tree

ACTION: Prevents the taxon being placed.

This checks if any of the synonyms of the taxon you are placing is a name already placed on the tree. You need
to replace or modify the accepted taxon.

=== check Synonyms Are Not Synonyms On The Tree

ACTION: Prevents the taxon being placed.

This checks if any of the synonyms of the taxon you are placing are a synonym of any name already placed on the tree.
You need to replace or modify the accepted taxon.
